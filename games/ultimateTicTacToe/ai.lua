...
--- the AI functions for the UltimateTicTacToe game.
-- @classmod AI
...
function AI:getName()
    ...
    return "UltimateTicTacToe Lua Player" -- REPLACE THIS WITH YOUR TEAM NAME!
...
-- @treturn string A move that the AI wants to make. Format varies based on sub-game
